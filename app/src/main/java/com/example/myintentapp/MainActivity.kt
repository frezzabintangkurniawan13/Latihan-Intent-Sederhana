    ...
    override fun onClick(v: View) {
        when (v.id) {
            ...
            R.id.btn_move_activity_data -> {
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Frezza Bintang Kurniawan");
            ...
            R.id.btn_move_activity_object -> {
                val person = Person(
                    "Frezza Bintang Kurniawan",
                    16,
                    "frezzabintang01@gmail.com",
                    "Pemalang"
                )
